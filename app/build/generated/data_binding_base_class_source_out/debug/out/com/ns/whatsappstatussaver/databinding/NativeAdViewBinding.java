...
public final class NativeAdViewBinding implements ViewBinding {
  ...
  private NativeAdViewBinding(@NonNull NativeAdView rootView, @NonNull TextView adAdvertiser,
  ...
  public static NativeAdViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NativeAdViewBinding((NativeAdView) rootView, adAdvertiser, adAppIcon, adBody,
